...
$FileName = "";
	...
	$sql = mysqli_query($connection, "
		...
		if (mysqli_num_rows($sql) > 0) {
			...
			<thead><tr><th>SN</th><th>Article Title</th> <th>Download Article</th><th>Assigned Editor</th> <th>Review Status</th> <th>Remarks</th></tr></thead>
			<tbody>";
    ...
    while($row = mysqli_fetch_assoc($sql)) {
		              ...
		              if(!empty($row['body']))
								  ...
								  <div class='modal-dialog' role='document'>
									<div class='modal-content'>
									  <div class='modal-header'>
										...
										$body2 = "<a href='download.php?att=".$row['attachement']."'><span>Download submitted Article</span></a>";
                    	...
                    	$message .= "<tr><td>".$sn."</td><td>".$row['title']."</td><td> ". $body2."  /   ". $body3."</td><td>".$editor."</td><td>".$review_status."</td><td>".$row['comment']."</td></tr>";
									}
						$message .= "<tbody></table>";
					}
				    else
