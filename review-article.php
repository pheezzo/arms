...
$FileName = "";
	...
	$sql = mysqli_query($connection, "
		...
		if (mysqli_num_rows($sql) > 0) {
			...
			<thead><tr><th>SN</th><th>Article Title</th> <th>Download Article</th> <th>Review Status</th> <th>Action</th></tr></thead>
			<tbody>";
    ...
    while($row = mysqli_fetch_assoc($sql)) {
		              ...
		              if(!empty($row['abstract']))
								  ...
								  <div class='modal-dialog' role='document'>
									<div class='modal-content'>
									  <div class='modal-header'>
										...
										$body2 = "<a href='".$row['document']."' target='_blank'><span>Download Full Article</span></a>";
										$review = "<a href='review.php?art=".$row['paper_id']."'><span>Review Article</span></a>";
                    	...
                    	$message .= "<tr><td>".$sn."</td><td>".$row['title']."</td><td>". $body."   ". $body2."</td><td>".$review_status."</td><td>".$review."</td></tr>";
									}
						$message .= "<tbody></table>";
					}
				    else
