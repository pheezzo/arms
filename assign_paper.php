		              ...
		              if(!empty($row['body']))
						...
						/*$body2 =" <button type='button' class='btn btn-primary' data-toggle='modal' data-target='#exampleModalLond".$sn."'>
							...
							/*$assign_form = "<form method = 'POST'  '>
										...
										$assign_form = "<a href='assign_editor.php?arti=".$row['article_id']."'><span>Assign Editor</span></a>";	
											
														 
                    	$message .= "<tr><td>".$sn."</td><td>".$row['title']."</td><td>". $body."   ". $body2."</td><td>".$row['name']."</td><td>".$assign_form."</td></tr>";
									}
						$message .= "<tbody></table>";
					}
				    else
