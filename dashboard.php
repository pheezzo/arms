              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                 ...
                 <span style=" color:#350A90"><strong>Web page: </strong></span><a href="<?php echo $row['event_webpage'] ; ?>" target="_blank"><?php echo $row['event_name'] ; ?></a> <br/>
                  <span style=" color:#350A90"><strong>Submission page: </strong></span><a href="submit_article.php?event=<?php echo $row['event_code'] ; ?>" target="_blank">submit_article.php?event=<?php echo $row['event_code'] ; ?></a> <br/>
